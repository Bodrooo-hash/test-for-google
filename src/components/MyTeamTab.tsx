...
import { Mail, Phone, Cake, Building2, UserCircle, Briefcase, Pencil, Check, X, Camera, Copy, Crown, Shield, ArrowLeft, User } from "lucide-react";
    ...
    <div className="flex items-center gap-3 py-2.5 group">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-1.5">
          <p className={cn("text-sm truncate transition-colors", copyable && value ? "group-hover:text-blue1 text-foreground/85" : "text-foreground/85 hover:text-blue1")}>{value || "—"}</p>
          {copyable && value && (
            <button
              onClick={handleCopy}
...
const MyTeamTab = ({ member: initialMember, onBack }: MyTeamTabProps) => {
  ...
  return (
    <div className="border border-border rounded-2xl bg-card overflow-hidden max-w-xl">
      <div className="relative">
        ...
        {/* Header with avatar */}
        <div className="p-6 pb-4 pt-10 flex items-center gap-4">
